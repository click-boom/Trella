...
def signup_frontend():
    ...
    email_img=tk.PhotoImage(file='D:/trela/Images/mail.png')    
    ...
    ehide_img=ImageTk.PhotoImage(Image.open('D:/trela/Images/hide_pwd.png'))
    chide_img=ImageTk.PhotoImage(Image.open('D:/trela/Images/hide_pwd.png'))
