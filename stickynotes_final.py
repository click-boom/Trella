...
def chk_frontend():
    ...
    dash_bg=tk.Label(dash, 
                     image=dashfr_img)
    dash_bg.image=dashfr_img
    dash_bg.pack(fill='both', expand='yes')

#------------------  textFrame  ---------------------------
    textFrame =tk.Frame(dash ,bg=dth_clr)    
    textFrame.place(x=30, y=70, width=400, height=800)
#----------------  Dashboard Heading  -------------------
    heading =tk.Label(dash , 
                      text='Sticky Notes',
...
#----------------  Logo Frame  -------------------
    ...
    lframe =tk.Frame(textFrame ,bg=dth_clr)    
...
# ====================  Button Labels  ========================
    ...
    chk_btn_lbl=tk.Label(textFrame, 
                         image=btn_img, 
                         bg=dth_clr)
    ...
    rem_btn_lbl=tk.Label(textFrame,
                         image=btn_img,
                         bg=dth_clr)
