...
#-------------------------------------------------------------
    text_dash=tk.Label(dash_bg,text='plan to Goa',font=('yu gothic ui', 44, 'bold'),bg=lth_clr, fg=dfnt)
    text_dash.place(x=700,y=300)
...
# ====================  Buttons  ==============================
    ...
    chk_btn=tk.Button(chk_btn_lbl, text='          CHECKLIST',font=('yu gothic ui', 25, 'bold'), bg=btn_bg, fg=lfnt, cursor='hand2', activebackground=btn_bg,activeforeground='white', bd=0,highlightthickness=0,command=check_link)
    ...
    rem_btn=tk.Button(rem_btn_lbl, text='          REMINDER',font=('yu gothic ui', 25, 'bold'), bg=btn_bg, fg='white', cursor='hand2', activebackground=btn_bg, activeforeground='white',bd=0,highlightthickness=0, command=remde_link)
    ...
    st_img.image=st_img
    st_btn=tk.Button(st_btn_lbl, text='       STICKY NOTES',font=('yu gothic ui', 25, 'bold'), bg=btn_bg, fg=lfnt, cursor='hand2', activebackground=btn_bg,activeforeground='white', bd=0,highlightthickness=0,command=stick_link)
