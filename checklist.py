...
icon=tk.PhotoImage(file='E:/trella/Images/llogo.png')
...
def chk_frontend():
    ...
    dashfr_img=ImageTk.PhotoImage(Image.open('E:/trella/Images/dash_bg.jpg'))
...
#----------------  checklist Heading  -------------------
    heading =tk.Label(dash , text='Checklist',font=('yu gothic ui', 44, 'bold'),bg=lth_clr, fg=dfnt)
...
#----------------  Logo Frame  -------------------
    ...
    dash_logo=ImageTk.PhotoImage(Image.open('E:/trella/Images/llogo.png'))
    ...
    logo_lbl=tk.Label(lframe, text='Hello user', bg= dth_clr, font=('yu gothic ui', 25, 'bold'), fg=lfnt)
    logo_lbl.image=dash_logo
    logo_lbl.pack(side='bottom') 

# ====================  Button Labels  =======================================================================
    #-----------------Checklist--------------------------
    btn_img=tk.PhotoImage(file='E:/trella/Images/DASH_BTN.png')
...
# ====================  Buttons  ================================================================================
    #-----------------  Checklist  --------------------------
    chk_img=ImageTk.PhotoImage(Image.open('E:/trella/Images/check-list.png'))
    ...
    rem_img=ImageTk.PhotoImage(Image.open('E:/trella/Images/dash_bg.jpg'))
    ...
    st_img=ImageTk.PhotoImage(Image.open('E:/trella/Images/dash_bg.jpg'))
    st_img.image=st_img
    global st_btn
...
#-----------------  Logout Button  --------------------------
    ...
    c1= tk.Checkbutton(dash,
                       ...
                       cursor='hand2',
                       activebackground='#d6d6d6')
    c1.place(x=450, y=450)
    
    c1= tk.Checkbutton(dash,
                       bg="#d6d6d6",
                       cursor='hand2',
                       activebackground='#d6d6d6')
    c1.place(x=450, y=500)

    c1= tk.Checkbutton(dash,
                       bg="#d6d6d6",
                       cursor='hand2',
                       activebackground='#d6d6d6')
    c1.place(x=450, y=550)
    ...
    c1= tk.Checkbutton(dash,
                       ...
                       cursor='hand2',
                       activebackground='#d6d6d6')
    c1.place(x=450, y=600)
    c1= tk.Checkbutton(dash,
                       bg="#d6d6d6",
                       cursor='hand2',
                       activebackground='#d6d6d6')
    c1.place(x=450, y=650)
    
    c1= tk.Checkbutton(dash,
                       bg="#d6d6d6",
                       cursor='hand2',
                       activebackground='#d6d6d6')
    c1.place(x=450, y=700)

    c1= tk.Checkbutton(dash,
                       bg="#d6d6d6",
                       cursor='hand2',
                       activebackground='#d6d6d6')
    c1.place(x=450, y=750)
