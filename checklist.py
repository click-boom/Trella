...
icon=tk.PhotoImage(file='D:/Trella\/mages\llogo.png')
...
def chk_frontend():
    ...
    dashfr_img=ImageTk.PhotoImage(Image.open('D:/Trella\/mages\dash_bg.jpg'))
...
#----------------  Logo Frame  -------------------
    ...
    dash_logo=ImageTk.PhotoImage(Image.open('D:/Trella\/mages\llogo.png'))
...
# ====================  Button Labels  ========================
    #-----------------Checklist--------------------------
    btn_img=tk.PhotoImage(file='D:/Trella\/mages\DASH_BTN.png')
...
# ====================  Buttons  ==============================
    ...
    chk_img=ImageTk.PhotoImage(Image.open('D:/Trella\/mages\check-list.png'))
    ...
    rem_img=ImageTk.PhotoImage(Image.open('D:/Trella\/mages\reminder.png'))
    ...
    st_img=ImageTk.PhotoImage(Image.open('D:/Trella\/mages\reminder.png'))
    st_img.image=st_img
